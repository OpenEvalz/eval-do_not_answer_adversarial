#!/usr/bin/env python3
"""Run ONE problem of do_not_answer_adversarial through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/do_not_answer_adversarial"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one do_not_answer_adversarial problem via TrustedRouter")
