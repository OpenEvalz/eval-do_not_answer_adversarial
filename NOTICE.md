...
`eval-do_not_answer_adversarial` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`register/do_not_answer_adversarial`)
